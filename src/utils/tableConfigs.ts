...
import { defaultSortFunction, defaultSortSubtestFunction } from './rowTemplateColumns';
  ...
  if (isSubtestTable) {
    return {
      ...
      platformConfig: {
        ...
        sortFunction: isMannWhitney ? defaultSortFunction : defaultSortSubtestFunction,
      },
    };
  }
